...
!function ($) {
    ...
    var Slider = function (element, options) {
        ...
        this.titleValuesStep = parseFloat(this.element.attr('data-slider-titlevaluesstep')) || options.titleValuesStep;
        ...
        if (!options.isTitleBar) {
            ...
            var valueAffix = options.titleValueAffix;
            var valueSuffix = options.titleValueSuffix;
            ...
            for (var i = this.min; i <= this.max; i += this.titleValuesStep) {
                ...
                val = valueAffix + val + valueSuffix;
        ...
        //keep the binding in case the system is touch capable as well as has mouse 
        this.picker.on({
